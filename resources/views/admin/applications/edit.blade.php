                ...
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <label class="form-check-label">
                      <input id="verified0" type="radio" name="is_done" value="0" class="form-check-input" @if(!$application->is_done) checked @endif/>
                      Не обработан
                  ...
                  <div class="form-check">
                    <label class="form-check-label">
                      <input id="verified1" type="radio" name="is_done" value="1" class="form-check-input" @if($application->is_done) checked @endif/>
                      Обработан
                      <i class="input-helper"></i>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  @if($application->resume)
                    <div class="mt-3">Документ:
                      <a href="{{ route('admin.download.resume', $application->resume) }}">Скачать</a>
                    </div>
                  @endif
                </div>
                <div class="form-group">
