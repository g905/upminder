		...
		<div class="col-md-12 grid-margin">
            ...
            @endif
						<div class="form-group">
							...
							<select name="categories[]" size="7" multiple class="multiple form-control-sm form-control" disabled>
                  ...
                  @endforeach
						...
						<div class="form-group">
							<label>Страна:</label>
							<select name="country_id" class="load_cities form-control-sm form-control" disabled>
                ...
                <label class="form-check-label">
                  ...
                  <i class="input-helper"></i>
					...
					<div class="card-body dynamic services">
								...
								@foreach ($services_list as $kk => $serv)
									<div class="row row_service{{ $kk + 1 }} row_service">
										<div class="col-md-3">
											<div class="form-group">
												<label>Название услуги: *</label>  
												<input type="text" name="service_service[]" value="{{ $serv->service->name }}" class="form-control" />
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
                        ...
                        <input type="text" name="" value="{{ $serv->currency ? $serv->currency->name : 'Нет валюты' }}" class="form-control" disabled/>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												<label>Цена в выбранной валюте: *</label>
												<input type="text" name="service_price[]" value="{{ $serv->price ? $serv->price : 'Нет Цены' }}" class="form-control" />
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
