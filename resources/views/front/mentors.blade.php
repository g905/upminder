    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4" >
            <div class="static_price_block">
                ...
                <span class="active_price">{{ $mentor->getActivePrice() }}  {{ $mentor->getDefaultCurrency()->code === "rub" ? "<span class='rub'>Р</span>" : "<span>$</span>" }}</span>
                <span class="old_price">{{ $mentor->getDefaultService()->price }} {{ $mentor->getDefaultCurrency()->code === "rub" ? "<span class='rub'>Р</span>" : "<span>$</span>" }}</span>
